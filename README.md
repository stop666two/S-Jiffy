...
S-Jiffy 是一个纯静态、零依赖的 Web 工具集，包含 **683 个** 即用型在线工具，覆盖编解码、加密哈希、文本处理、颜色转换、数学计算、网络工具、随机生成、代码生成、DevOps、安全工具、图片处理、音频处理等 **36 个分类**。所有工具均为单页 HTML，无需构建、无需服务端、无需注册，打开即用。
...
### 日期时间 (37)
年龄计算器 · 计时器 · 倒计时器 · 在线闹钟 · Cron 表达式解析 · Crontab 生成器 · 日期差计算 · ETA 计算器 · 番茄钟 · 在线率计算器 · 工作日计算器 · 工时计算 · Cron 表达式验证 · 日期计算 · 日期纪年 · 间歇计时器 · 闰年检测 · 月相 · 日出日落时间 · 时间推算 · 时间间隔 · 计时器与秒表 · 时区转换 · ISO 周数 · 年度进度 · 日期格式化器 · 生肖年龄查询 · 预产期计算 · 日历生成器 · 时间单位转换器 · 日期序列生成器 · 中国节假日速查 · 跨时区会议安排器 · 万年历 · 老黄历 · 日期时间计算器 · 日期计算器

### 生活 (36)
车牌号归属地查询 · 小费计算器 · 电费计算器 · 油耗计算器 · 星座查询 · 生肖年龄查询 · 睡眠周期计算器 · 决策助手 · 简易待办清单 · 每日饮水计算 · 血液酒精估算 · 中国节假日速查 · 跨时区会议安排器 · 开发者每日清单 · 视频剪切 · 在线鼓机 · 部首查字 · 汉字偏旁查询 · 月老灵签 · 财神灵签 · 黄大仙灵签 · 吕祖灵签 · 关帝灵签 · 周公灵签 · 世界各国国旗 · 观音灵签 · 车公灵签 · 土地公灵签 · 王公灵签 · 玉帝灵签 · 佛祖灵签 · 六爻排盘 · 答案之书 · 电子木鱼 · 货币汇率转换 · 在线记事本
...
### 编解码 (26)
Base32 编解码 · Base58 编解码 · Base64 编解码 · Base64 转图片 · Base85 编解码 · Bencode 编解码 · 图片转 Base64 · 摩斯密码 · QR 码读取器 · Base36 编解码 · Base62 编解码 · Punycode 转换 · Ascii85 编解码 · Base45 编解码 · Base91 编解码 · Base92 编解码 · 摩斯音频 · Quoted-Printable 编解码 · UUencode 编解码 · Data URI 生成 · Protobuf JSON 互转 · MessagePack 编解码 · 十六进制查看器 · 分隔符检测器 · 编码转换器 · 文本编码转换器
...
### 进制转换 (14)
进制转换 · Hex RGB Decimal 转换 · IPv4 地址转换器 · 文本与二进制互转 · Base36 编解码 · Base62 编解码 · 通用进制转换 · 进制转换进阶 · IP 格式转换 · 字节序转换 · 科学计数法转换器 · 数字进制转换器 · 二进制计算器 · 位运算计算器

### 单位换算 (12)
面积单位转换 · 字节格式化 · CSS 单位转换 · 数据存储单位转换 · 长度单位转换 · 速度单位转换 · 温度转换器 · 体积单位转换 · 重量单位转换 · 距离计算器 · 时间单位转换器 · 单位换算器
...
### 金融 (7)
贷款计算器 · 投资回报计算器 · 复利计算器 · 增值税计算器 · 中文大写金额 · 银行卡BIN查询 · 货币汇率转换

### 游戏 (36)
打字速度测试 · 反应速度测试 · 记忆测试 · 在线鼓机 · 瞄准训练 · CPS测试 · 游戏灵敏度转换器 · Valorant灵敏度转换器 · CS2灵敏度转换器 · Apex英雄灵敏度转换器 · 守望先锋2灵敏度转换器 · 彩虹六号围攻灵敏度转换器 · 绝地求生灵敏度转换器 · 堡垒之夜灵敏度转换器 · 使命召唤灵敏度转换器 · 逃离塔科夫灵敏度转换器 · 战地2042灵敏度转换器 · 光环无限灵敏度转换器 · The Finals灵敏度转换器 · 星际战甲灵敏度转换器 · CS2转Valorant灵敏度转换器 · Valorant转CS2灵敏度转换器 · Apex转Valorant灵敏度转换器 · Valorant转Apex灵敏度转换器 · CS2转Apex灵敏度转换器 · Apex转CS2灵敏度转换器 · 守望先锋2转Valorant灵敏度转换器 · Valorant转守望先锋2灵敏度转换器 · CS2转守望先锋2灵敏度转换器 · 守望先锋2转CS2灵敏度转换器 · 绝地求生转CS2灵敏度转换器 · CS2转绝地求生灵敏度转换器 · 堡垒之夜转Valorant灵敏度转换器 · Valorant转堡垒之夜灵敏度转换器 · 使命召唤转CS2灵敏度转换器 · CS2转使命召唤灵敏度转换器
...
### 图片处理 (23)
PNG转JPG转换器 · JPG转PNG转换器 · WebP转JPG转换器 · JPG转WebP转换器 · WebP转PNG转换器 · PNG转WebP转换器 · HEIC转JPG转换器 · HEIC转PNG转换器 · AVIF转JPG转换器 · AVIF转PNG转换器 · SVG转PNG转换器 · SVG转JPG转换器 · 图片压缩器 · 背景去除器 · 图片调整大小 · 图片裁剪器 · 图片旋转器 · 图片滤镜效果 · 水印工具 · 在线画板 · 批量图片处理器 · 视频转GIF工具 · MP4转GIF工具
